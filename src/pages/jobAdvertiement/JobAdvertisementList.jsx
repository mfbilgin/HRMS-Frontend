...
const JobAdvertisementList = () => {
    ...
    useEffect(() => {
        ...
        jobAdvertisementService.getByStatusIsTrueAndOrderByApplicationDeadlineAsc().then(result => setJobAdvertisement(result.data.data));
    }, []);
    return (
        <div style={{margin: 20}}>
            <Grid>
                            ...
                            <Table.Body>
                                {
                                    jobAdvertisement.map(jobAdvertisement => (
                                        <Table.Row key={jobAdvertisement.id} textAlign={'center'}>
                                            ...
                                            <Table.Cell>
                                                <Button color={"grey"} animated as={Link} to={`/jobAdvertisementDetails/${jobAdvertisement.id}`}>
